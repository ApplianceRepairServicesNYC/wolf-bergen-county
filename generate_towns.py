...
TOWNS = [
    ...
    ("Fairview", "fairview", "Southern Bergen County", "diverse community", "convenient transportation access"),
    ...
    ("North Arlington", "north-arlington", "Southern Bergen County", "residential borough", "easy commute options"),
    ...
    ("Ridgefield", "ridgefield", "Southern Bergen County", "residential borough", "diverse community character"),
